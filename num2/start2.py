...
# model.addLayerInput(X_assess.shape[0])
#
# model.addHidenLayer(4,act_func=fw.tanh)
#
# model.addOutputLayer(Y_assess.shape[0],act_func=fw.sigmoid)
#
# model.set_parameters(parameters)
#
# model.set_cashe(cache,X_assess)
#
# grads = model.backward_propagation(X_assess,Y_assess)
#
# print ("dW1 = "+ str(grads["dW1"]))
# print ("db1 = "+ str(grads["db1"]))
# print ("dW2 = "+ str(grads["dW2"]))
...
# model.addOutputLayer(Y_assess.shape[0],act_func=fw.sigmoid)
#
# parameters = model.train(X_assess,Y_assess,num_iterations=10000,print_cost=True)
...
#
#model.addHidenLayer(8,act_func=fw.sigmoid)
...
from dlFramework import dlfw as fw1
